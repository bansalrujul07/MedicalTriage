...
"""
FastAPI application for the Triage Env Environment.

This module creates an HTTP server that exposes the TriageEnvironment
...
def run_server(host: str = "0.0.0.0", port: int = 8000):
    ...
    This function enables running the server without Docker:
        ...
        python -m triage_env.server.app
    ...
    multiple workers:
        uvicorn triage_env.server.app:app --workers 4
    """
    import uvicorn
...
def main() -> None:
    """CLI entry point expected by OpenEnv validators."""
    import argparse
